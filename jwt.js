...
var i 	= 'Spsol';    	// Issuer (Software organization who issues the token)
var s 	= 'admin@spsol.io';	// Subject (intended user of the token)
var a 	= 'https://spsol.io';	// Audience (Domain within which this token will live and function)
